...
if ( !function_exists( 'meks_ess_share' ) ):
	function meks_ess_share( $options = array(), $echo = true, $before = '', $after = '' ) {
		...
		$share['linkedin'] = '<a href="#" onclick="return false;"  class="meks_ess-item socicon-linkedin" data-url="http://www.linkedin.com/shareArticle?mini=true;url=' . $url . ';title=' . $title . '"><span>'.__( 'LinkedIn', 'meks-easy-social-share' ).'</span></a>';
